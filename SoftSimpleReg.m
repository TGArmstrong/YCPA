...
epi{1}(125:150,55:95)= c_eps_0*11.3; % This is the inclusion.
epi{1}(25:50,55:95)= c_eps_0*11.3; % Extra blocks of dielectric
...
epi{1}(35:45,122:125)= c_eps_0*11.3;
epi{1}(50:55,115:125)= c_eps_0*11.3;
epi{1}(60:65,115:125)= c_eps_0*11.3;
epi{1}(55:60,115:117)= c_eps_0*11.3;
epi{1}(70:75,115:125)= c_eps_0*11.3;
epi{1}(75:80,115:117)= c_eps_0*11.3;
epi{1}(75:80,123:125)= c_eps_0*11.3;
epi{1}(75:80,119:121)= c_eps_0*11.3;
epi{1}(95:100,115:125)= c_eps_0*11.3;
epi{1}(105:110,115:125)= c_eps_0*11.3;
epi{1}(100:110,122:125)= c_eps_0*11.3;
epi{1}(100:110,117:119)= c_eps_0*11.3;
...
% bc contains the boundary conditions for the solver.
bc{1}.NumS = 1;
% bc.s is the source of the EM wave.
